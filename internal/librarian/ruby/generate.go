...
// toysEnv configures the environment for running toys tasks. Unlike toolsEnv,
// it does not set GEM_HOME or default GEM_PATH to installDir, allowing Ruby to
// locate system- and user-installed gems (including toys).
